...
class PushQuickDatabasesData extends Migration
{
  ...
  public function up()
  {
    $data = [[
      ...
      'database' => 'ip_pools',
      'del' => '',
      'list' => '{"page":20,"multiple":true,"select":["*"],"button":["create","update","delete","export"],"order":[{"label":"id","type":"desc"}],"form":{"width":400,"span":[24]},"export":[{"value":"id","label":"序号","width":20},{"value":"ip","label":"IP地址","width":50},{"value":"region","label":"解析地址","width":0},{"value":"created_at","label":"创建时间","width":50}],"table":[{"value":"id","label":"序号","type":"string","width":60},{"value":"ip","label":"IP地址","type":"string","width":200},{"value":"region","label":"解析地址","type":"string","width":0},{"value":"created_at","label":"创建时间","type":"string","width":200}]}',
